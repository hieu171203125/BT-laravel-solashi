                ...
                <div class="row align-items-center no-gutters">
                    <div class="col-lg-3 col-md-12">
                        <div class="logo mb-all-30">
                            <a href="{{Route('web.index')}}"><img src="{{asset('public/web/img/logo/logo.png')}}" alt="logo-image"></a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="cart-box mt-all-30">
                            <ul class="d-flex justify-content-lg-end justify-content-center align-items-center">
                                    ...
                                    <ul class="ht-dropdown cart-box-width">
                                        <li>
                                            ...
                                            <div class="single-cart-box">
                                                <div class="cart-img">
                                                    <a href="#"><img src="{{asset(''.$value['info']['images'][0]->path)}}" alt="cart-image"></a>
                                                    <span class="pro-quantity">{{$value['quantity']}}X</span>
                                                </div>
                                                <div class="cart-content">
                                                    <h6><a href="product.html">{{$value['info']->name}}</a></h6>
                                                    <span class="cart-price">{{number_format($value['info']->price)}}</span>
                                                </div>
                                                <a class="del-icone" href="{{Route('web.cart.delete',['product_id'=>$key])}}"><i class="ion-close"></i></a>
                                            </div>
                                            @endforeach
                                            <!-- Cart Box End -->
                                ...
                                <li>
                                    <a href="#"><i class="lnr lnr-user"></i><span class="my-cart"><span><strong>{{Session::get('customer_name')}}</strong></span></a>
                                    <ul class="ht-dropdown cart-box-width">
                                ...
                                <?php else: ?>
                                <li>
                                    <a href="{{Route('web.signin')}}"><i class="lnr lnr-user"></i><span class="my-cart"><span><strong>Sign in</strong></span></a>
                                </li>
                                <?php endif ?>
                        ...
                        <ul class="header-bottom-list d-flex">
                            ...
                            <li><a href="shop.html">Category<i class="fa fa-angle-down"></i></a>
                                ...
                                <ul class="ht-dropdown dropdown-style-two">
                                    ...
                                    <li><a href="{{Route('web.category',['category_id'=>$value->id])}}">{{$value->name}}</a></li>
                                    <?php endforeach ?>
                                </ul>
            ...
            <div class="single-footer mb-sm-40">
                ...
                <div class="footer-content">
                    ...
                    <div class="payment mt-25 bdr-top pt-30">
                        <a href="#"><img class="img" src="{{asset('public/web/img/payment/1.png')}}" alt="payment-image"></a>
                    </div>                                   
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="footer-middle-content pt-20 pb-30">
            <ul class="social-footer">
                ...
                <li><a href="#"><img src="{{asset('public/web/img/icon/social-img1.png')}}" alt="google play"></a></li>
                <li><a href="#"><img src="{{asset('public/web/img/icon/social-img2.png')}}" alt="app store"></a></li>
            </ul>
        </div>
    </div>
    <!-- Container End -->
