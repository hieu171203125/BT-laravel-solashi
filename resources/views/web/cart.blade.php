						...
						<table>
							...
							<tbody>
								...
								<tr>
									...
									<td class="product-name"><a href="#">{{$value['info']->name}}</a></td>
									<td class="product-price"><span class="amount">{{$value['info']->price}}</span></td>
									<td class="product-quantity"><input type="number" name="quantity[{{$key}}]" value="{{$value['quantity']}}"></td>
									<td class="product-subtotal">{{$value['total']}}</td>
									<td class="product-remove"> <a href="{{route('web.cart.delete',['product_id'=>$key])}}"><i class="fa fa-times" aria-hidden="true"></i></a></td>
								</tr>
								@endforeach
								@endif
							</tbody>
					...
					<div class="row">
						...
						<div class="col-md-8 col-sm-12">
							<div class="buttons-cart">
								...
								<a href="{{route('web.index')}}">Continue Shopping</a>
							</div>
						</div>
						<!-- Cart Button Start -->
						<!-- Cart Totals Start -->
								...
								<table class="float-md-right">
									<tbody>
										...
										<tr class="order-total">
											<th>Total</th>
											<td>
												<strong><span class="amount">{{Session::get('cart')->totalPrice}}</span></strong>
											</td>
										</tr>
									</tbody>
								</table>
